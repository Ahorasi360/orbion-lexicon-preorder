  ...
  return (
    <PlatformShell>
      ...
      <section className="lexicon-browser"><div className="platform-container">
        <aside className="catalog-access-bridge"><div><p className="entry-section-label">MEMBER ACCESS</p><strong>The full connected Lexicon is available with annual access.</strong><span>Names, aliases, and domains remain searchable here. Full explanations, evidence, sources, and connections are protected for members.</span></div><Link href="/lexicon/access">Unlock annual access — $79 →</Link></aside>
