...
export default function Home() {
  ...
  return (
    <div className="orbion-site">
      ...
      <footer><div className="footer-brand"><span>THE ORBION</span><strong>SPACE LEXICON</strong></div><nav className="book-footer-links" aria-label="Orbion platform links"><a href="/">Explore</a><a href="/lexicon">Lexicon</a><a href="/domains">Domains</a><a href="/maps">Maps</a><a href="/methodology">Methodology</a><a href="/sources">Sources</a><a href="/about">About</a><a href="/intelligence">Intelligence</a></nav><PolicyLinks /><p>© 2026 Anthony Galeano · Founder, Orbion</p><button onClick={() => scrollTo("top")}>Back to top ↑</button></footer>
