...
export default function LexiconEntryPage() {
  ...
  return <PlatformShell>
    <Seo title={`${entry.canonicalName} | Orbion Online Lexicon`} description={entry.publicTeaser} canonicalPath={`/lexicon/${entry.slug}`} structuredData={structuredData} noindex={data.access === "locked" || entry.indexStatus !== "index"} />
